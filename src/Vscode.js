    ...
    return (
       ...
       >
            <div className= {isMaximize?'absolute w-screen h-screen flex flex-col': 'absolute w-4/6 h-5/6'} style={{zIndex:  (zindexindex.VsCode.toString()) }}>
                ...
                <iframe src="https://github1s.com/UjjwalD77/FullForce-Aio-Tool/blob/main/FullForce.py" title="Unofficial Github Editor"  encrypted-media  picture-in-picture  className="h-full w-full bg-ub-cool-grey "></iframe>
